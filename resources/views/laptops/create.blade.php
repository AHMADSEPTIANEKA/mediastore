...
<body class="bg-gray-50 text-gray-900">
    <div class="container mx-auto p-6">
        <h2 class="text-3xl font-bold mb-4">➕ Add Laptop</h2>
        ...
        <form action="{{ route('laptops.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="type" id="type" class="w-full p-3 border border-gray-300 rounded-md" required>
                    <option value="" disabled selected>Select Laptops Type</option>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="ram" id="ram" class="w-full p-3 border border-gray-300 rounded-md" required>
            </div>

            <div class="mb-4">
                <label for="storage" class="block text-lg font-semibold">Storage (GB)</label>
                <input type="number" name="storage" id="storage" class="w-full p-3 border border-gray-300 rounded-md" required>
            </div>

            <div class="mb-4">
                <label for="screen_size" class="block text-lg font-semibold">Screen Size (inches)</label>
                <input type="text" name="screen_size" id="screen_size" class="w-full p-3 border border-gray-300 rounded-md" required>
            </div>

            <div class="mb-4">
                <label for="battery_life" class="block text-lg font-semibold">Battery Life (hours)</label>
                <input type="text" name="battery_life" id="battery_life" class="w-full p-3 border border-gray-300 rounded-md" required>
            </div>
            ...
            <!-- Tombol Submit -->
            <div class="mb-4">
                <button type="submit" class="bg-green-600 text-white px-6 py-3 rounded-lg shadow hover:bg-green-700">Add Laptop</button>
